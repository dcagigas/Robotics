...
directory_model_50="model_50_results/"
directory_model_54="model_54_results/"
...
def get_best_solution (end_point, model_list, model_number):
    ...
    best_error=-1
    best_solution=[]
    if not (model_number>=0 and model_number<=100):
...
if __name__ == '__main__':
    ...
    test_bootstrapping_approach_with_N_models (test_samples_size, dataMat, 54, model_list, directory_model_54)
